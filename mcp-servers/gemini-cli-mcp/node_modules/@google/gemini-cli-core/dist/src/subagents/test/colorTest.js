...
export class ColorTest {
    ...
    runAgentSpeechTest() {
        ...
        const agents = [
            { id: 'code-review-1', name: 'コードレビューエージェント', specialty: 'code_review' },
            { id: 'debug-1', name: 'デバッグエージェント', specialty: 'debugging' },
        ...
        agents.forEach((agent, index) => {
            console.log(this.colorManager.formatAgentSpeech(agent.id, agent.name, agent.specialty, messages[index]));
        });
        console.log('\n' + '='.repeat(50) + '\n');
    }
    /**
    ...
    runCustomColorTest() {
        ...
        console.log(this.colorManager.formatAgentSpeech('special-agent', '特別エージェント', 'custom', 'これは特別な色で表示されるメッセージです。'));
        console.log(this.colorManager.formatAgentSpeech('vip-agent', 'VIPエージェント', 'custom', 'これはVIPエージェントのメッセージです。'));
        console.log('\n' + '='.repeat(50) + '\n');
    }
    /**
     * 全テスト実行
