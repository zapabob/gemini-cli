 ...
 * リアルタイムメッセージタイプ
 */
export type RealTimeMessageType = 'task_assignment' | 'task_progress' | 'task_completion' | 'task_error' | 'coordination_request' | 'coordination_response' | 'status_update' | 'heartbeat' | 'emergency_stop' | 'checkpoint_save' | 'checkpoint_restore' | 'subagent_ready' | 'subagent_busy' | 'main_agent_directive' | 'subagent_report' | 'integration_request' | 'integration_result' | 'error_report' | 'performance_metrics' | 'session_control';
/**
 * リアルタイム通信セッション設定
 */
