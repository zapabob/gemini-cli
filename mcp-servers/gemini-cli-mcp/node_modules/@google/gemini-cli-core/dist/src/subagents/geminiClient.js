...
export class GeminiClient {
     ...
     * サブエージェント用のプロンプトを生成
     */
    generateSubagentPrompt(subagent, task, context) {
...
タスク: ${task}`;
     ...
     * サブエージェントのタスクを実行
     */
    async executeSubagentTask(subagent, task, context, options = {}) {
     ...
     * 複数のサブエージェントで並列実行
     */
    async executeParallelTasks(subagents, task, context, options = {}) {
