...
export class ColorManager {
     ...
     * サブエージェントの色を取得または生成
     */
    getAgentColor(agentId, specialty) {
        // 既存の色があれば返す
     ...
     * 色付きメッセージを生成
     */
    createColoredMessage(text, agentId, agentName, specialty, type = 'agent_speech') {
     ...
     * サブエージェントの会話メッセージを生成
     */
    formatAgentSpeech(agentId, agentName, specialty, message) {
     ...
     * システムメッセージを生成
     */
    formatSystemMessage(message, type = 'info') {
     ...
     * 進捗メッセージを生成
     */
    formatProgressMessage(message, agentId, agentName) {
     ...
     * エラーメッセージを生成
     */
    formatErrorMessage(message, agentId, agentName) {
     ...
     * 成功メッセージを生成
     */
    formatSuccessMessage(message, agentId, agentName) {
