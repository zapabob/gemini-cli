...
import type { ToolCallRequestInfo, ToolCallResponseInfo } from '../scheduler/types.js';
/**
 ...
 */
export declare function executeToolCall(config: Config, request: ToolCallRequestInfo, signal: AbortSignal): Promise<ToolCallResponseInfo>;
