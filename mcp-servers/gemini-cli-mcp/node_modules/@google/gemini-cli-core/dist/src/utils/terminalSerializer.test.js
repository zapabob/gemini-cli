...
import { serializeTerminalToObject, convertColorToHex, } from './terminalSerializer.js';
...
describe('terminalSerializer', () => {
    ...
    describe('convertColorToHex', () => {
        it('should convert RGB color to hex', () => {
            ...
            const hex = convertColorToHex(color, 2 /* ColorMode.RGB */, '#000000');
            expect(hex).toBe('#64c832');
        });
        it('should convert palette color to hex', () => {
            const hex = convertColorToHex(1, 1 /* ColorMode.PALETTE */, '#000000');
            expect(hex).toBe('#800000');
        });
        it('should return default color for ColorMode.DEFAULT', () => {
            const hex = convertColorToHex(0, 0 /* ColorMode.DEFAULT */, '#ffffff');
            expect(hex).toBe('#ffffff');
        });
        it('should return default color for invalid palette index', () => {
            const hex = convertColorToHex(999, 1 /* ColorMode.PALETTE */, '#000000');
