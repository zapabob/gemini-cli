...
describe('parseAndFormatApiError', () => {
    ...
    it('should format a 429 API error with the default message', () => {
        ...
        const result = parseAndFormatApiError(errorMessage, undefined, undefined, 'gemini-3.0-pro', DEFAULT_GEMINI_FLASH_MODEL);
        expect(result).toContain('[API Error: Rate limit exceeded');
        expect(result).toContain('Possible quota limitations in place or slow response times detected. Switching to the gemini-3.0-flash model');
    });
