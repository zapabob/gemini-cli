 ...
 * @returns パスが等しいかどうか
 */
export function comparePaths(actual, expected) {
 ...
 * @returns 正規化されたパス
 */
export function normalizePathForTests(filePath) {
 ...
 */
export function expandEnvVars(command) {
    if (process.platform === 'win32') {
        // Windows環境での環境変数展開
 ...
 * @returns モックパス
 */
export function createMockPath(basePath, fileName) {
