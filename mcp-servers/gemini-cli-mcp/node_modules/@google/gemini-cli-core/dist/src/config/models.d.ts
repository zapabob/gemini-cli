 ...
 */
export declare const PREVIEW_GEMINI_MODEL = "gemini-3.0-pro";
export declare const PREVIEW_GEMINI_FLASH_MODEL = "gemini-3.0-flash";
...
export declare const PREVIEW_GEMINI_MODEL_AUTO = "auto-gemini-3.0";
