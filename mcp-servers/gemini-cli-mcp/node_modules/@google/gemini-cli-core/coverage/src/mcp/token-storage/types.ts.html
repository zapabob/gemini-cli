...
<head>
    <title>Code coverage report for src/mcp/token-storage/types.ts</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
    <div class='pad1'>
        <h1><a href="../../../index.html">All files</a> / <a href="index.html">src/mcp/token-storage</a> types.ts</h1>
        <div class='clearfix'>
...
&nbsp;
<span class="cstat-no" title="statement not covered" >export enum TokenStorageType {</span>
<span class="cstat-no" title="statement not covered" >  KEYCHAIN = 'keychain',</span>
<span class="cstat-no" title="statement not covered" >  ENCRYPTED_FILE = 'encrypted_file',</span>
}
&nbsp;</pre></td></tr></table></pre>
