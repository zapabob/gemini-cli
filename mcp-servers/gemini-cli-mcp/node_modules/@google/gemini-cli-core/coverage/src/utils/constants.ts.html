 ...
 */
&nbsp;
<span class="cstat-no" title="statement not covered" >export const REFERENCE_CONTENT_START = '--- Content from referenced files ---';</span>
<span class="cstat-no" title="statement not covered" >export const REFERENCE_CONTENT_END = '--- End of content ---';</span>
&nbsp;</pre></td></tr></table></pre>
