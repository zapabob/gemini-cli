...
<head>
    <title>Code coverage report for src/utils/session.ts</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
    <div class='pad1'>
        <h1><a href="../../index.html">All files</a> / <a href="index.html">src/utils</a> session.ts</h1>
        <div class='clearfix'>
...
&nbsp;
<span class="cstat-no" title="statement not covered" >export const sessionId = randomUUID();</span>
&nbsp;</pre></td></tr></table></pre>
