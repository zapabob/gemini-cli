...
<head>
    <title>Code coverage report for src/utils/browser.ts</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
    <div class='pad1'>
        <h1><a href="../../index.html">All files</a> / <a href="index.html">src/utils</a> browser.ts</h1>
        <div class='clearfix'>
 ...
 */
<span class="cstat-no" title="statement not covered" >export function shouldAttemptBrowserLaunch(): boolean {</span>
...
<span class="cstat-no" title="statement not covered" >  if (isSSH &amp;&amp; process.platform !== 'linux') {</span>
<span class="cstat-no" title="statement not covered" >    return false;</span>
<span class="cstat-no" title="statement not covered" >  }</span>
&nbsp;
