...
<head>
    <title>Code coverage report for src/utils/googleErrors.ts</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
    <div class='pad1'>
        <h1><a href="../../index.html">All files</a> / <a href="index.html">src/utils</a> googleErrors.ts</h1>
        <div class='clearfix'>
            
            <div class='fl pad1y space-right2'>
                <span class="strong">72.05% </span>
                <span class="quiet">Statements</span>
                <span class='fraction'>98/136</span>
            </div>
...
&nbsp;
  ...
  if (typeof errorObj === 'string') <span class="branch-0 cbranch-no" title="branch not covered" >{</span>
<span class="cstat-no" title="statement not covered" >    try {</span>
<span class="cstat-no" title="statement not covered" >      errorObj = JSON.parse(errorObj);</span>
...
<span class="cstat-no" title="statement not covered" >  }</span>
&nbsp;
  if (Array.isArray(errorObj<span class="branch-0 cbranch-no" title="branch not covered" >) &amp;&amp; errorObj.length &gt; 0) <span class="branch-0 cbranch-no" title="branch not covered" >{</span></span>
<span class="cstat-no" title="statement not covered" >    errorObj = errorObj[0];</span>
<span class="cstat-no" title="statement not covered" >  }</span>
&nbsp;
  if (typeof errorObj !== 'object' || errorObj === null) <span class="branch-0 cbranch-no" title="branch not covered" >{</span>
<span class="cstat-no" title="statement not covered" >    return null;</span>
<span class="cstat-no" title="statement not covered" >  }</span>
&nbsp;
    ...
    if (Array.isArray(errorDetails)) {
      for (const detail of errorDetails) {
        if (detail &amp;&amp; typeof detail === 'object') {
          ...
          if (typeKey) {
            if (typeKey !== '@type') <span class="branch-0 cbranch-no" title="branch not covered" >{</span>
<span class="cstat-no" title="statement not covered" >              detailObj['@type'] = detailObj[typeKey];</span>
<span class="cstat-no" title="statement not covered" >              delete detailObj[typeKey];</span>
<span class="cstat-no" title="statement not covered" >            }</span>
...
&nbsp;
  ...
  if (gaxiosError.<span class="branch-0 cbranch-no" title="branch not covered" >response?.data) <span class="branch-0 cbranch-no" title="branch not covered" >{</span></span>
<span class="cstat-no" title="statement not covered" >    let data = gaxiosError.response.data;</span>
&nbsp;
...
<span class="cstat-no" title="statement not covered" >    }</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >    if (Array.isArray(data) &amp;&amp; data.length &gt; 0) {</span>
...
<span class="cstat-no" title="statement not covered" >        outerError = (data as { error: ErrorShape }).error;</span>
<span class="cstat-no" title="statement not covered" >      }</span>
<span class="cstat-no" title="statement not covered" >    }</span>
<span class="cstat-no" title="statement not covered" >  }</span>
&nbsp;
...
<span class="branch-0 cbranch-no" title="branch not covered" >            } catch (__) {</span>
              // Still failed
<span class="cstat-no" title="statement not covered" >            }</span>
          }
        }
...
&nbsp;
    if (Array.isArray(data<span class="branch-0 cbranch-no" title="branch not covered" >) &amp;&amp; data.length &gt; 0) <span class="branch-0 cbranch-no" title="branch not covered" >{</span></span>
<span class="cstat-no" title="statement not covered" >      data = data[0];</span>
<span class="cstat-no" title="statement not covered" >    }</span>
&nbsp;
