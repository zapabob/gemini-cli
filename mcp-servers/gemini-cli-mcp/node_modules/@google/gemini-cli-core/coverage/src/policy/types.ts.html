...
<head>
    <title>Code coverage report for src/policy/types.ts</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
    <div class='pad1'>
        <h1><a href="../../index.html">All files</a> / <a href="index.html">src/policy</a> types.ts</h1>
        <div class='clearfix'>
...
<a name='L279'></a><a href='#L279'>279</a></td><td class="line-coverage quiet"><span class="cline-any cline-no">&nbsp;</span>
...
&nbsp;
<span class="cstat-no" title="statement not covered" >export enum PolicyDecision {</span>
<span class="cstat-no" title="statement not covered" >  ALLOW = 'allow',</span>
<span class="cstat-no" title="statement not covered" >  DENY = 'deny',</span>
<span class="cstat-no" title="statement not covered" >  ASK_USER = 'ask_user',</span>
}
&nbsp;
/**
 ...
 */
<span class="cstat-no" title="statement not covered" >const VALID_HOOK_SOURCES: HookSource[] = [</span>
 ...
 */
<span class="cstat-no" title="statement not covered" >export function getHookSource(input: Record&lt;string, unknown&gt;): HookSource {</span>
<span class="cstat-no" title="statement not covered" >  const source = input['hook_source'];</span>
<span class="cstat-no" title="statement not covered" >  if (</span>
<span class="cstat-no" title="statement not covered" >    typeof source === 'string' &amp;&amp;</span>
<span class="cstat-no" title="statement not covered" >    VALID_HOOK_SOURCES.includes(source as HookSource)</span>
<span class="cstat-no" title="statement not covered" >  ) {</span>
<span class="cstat-no" title="statement not covered" >    return source as HookSource;</span>
<span class="cstat-no" title="statement not covered" >  }</span>
<span class="cstat-no" title="statement not covered" >  return 'project';</span>
<span class="cstat-no" title="statement not covered" >}</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >export enum ApprovalMode {</span>
<span class="cstat-no" title="statement not covered" >  DEFAULT = 'default',</span>
<span class="cstat-no" title="statement not covered" >  AUTO_EDIT = 'autoEdit',</span>
<span class="cstat-no" title="statement not covered" >  YOLO = 'yolo',</span>
<span class="cstat-no" title="statement not covered" >  PLAN = 'plan',</span>
}
&nbsp;
/**
...
&nbsp;
<span class="cstat-no" title="statement not covered" >export enum InProcessCheckerType {</span>
<span class="cstat-no" title="statement not covered" >  ALLOWED_PATH = 'allowed-path',</span>
}
&nbsp;
/**
