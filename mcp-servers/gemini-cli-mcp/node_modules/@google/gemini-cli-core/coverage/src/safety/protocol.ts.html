...
<head>
    <title>Code coverage report for src/safety/protocol.ts</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
    <div class='pad1'>
        <h1><a href="../../index.html">All files</a> / <a href="index.html">src/safety</a> protocol.ts</h1>
        <div class='clearfix'>
 ...
 */
<span class="cstat-no" title="statement not covered" >export enum SafetyCheckDecision {</span>
