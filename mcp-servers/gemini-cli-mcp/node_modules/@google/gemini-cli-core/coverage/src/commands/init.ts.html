...
&nbsp;
<span class="cstat-no" title="statement not covered" >export function performInit(doesGeminiMdExist: boolean): CommandActionReturn {</span>
<span class="cstat-no" title="statement not covered" >  if (doesGeminiMdExist) {</span>
...
<span class="cstat-no" title="statement not covered" >        'A GEMINI.md file already exists in this directory. No changes were made.',</span>
<span class="cstat-no" title="statement not covered" >    };</span>
<span class="cstat-no" title="statement not covered" >  }</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >  return {</span>
<span class="cstat-no" title="statement not covered" >    type: 'submit_prompt',</span>
<span class="cstat-no" title="statement not covered" >    content: `</span>
