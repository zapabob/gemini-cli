...
<head>
    <title>Code coverage report for src/scheduler/types.ts</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
    <div class='pad1'>
        <h1><a href="../../index.html">All files</a> / <a href="index.html">src/scheduler</a> types.ts</h1>
        <div class='clearfix'>
...
&nbsp;
<span class="cstat-no" title="statement not covered" >export const ROOT_SCHEDULER_ID = 'root';</span>
&nbsp;
