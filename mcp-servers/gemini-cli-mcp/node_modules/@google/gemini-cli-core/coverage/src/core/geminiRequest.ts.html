...
<head>
    <title>Code coverage report for src/core/geminiRequest.ts</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
    <div class='pad1'>
        <h1><a href="../../index.html">All files</a> / <a href="index.html">src/core</a> geminiRequest.ts</h1>
        <div class='clearfix'>
...
&nbsp;
<span class="cstat-no" title="statement not covered" >export function partListUnionToString(value: PartListUnion): string {</span>
<span class="cstat-no" title="statement not covered" >  return partToString(value, { verbose: true });</span>
