...
<head>
    <title>Code coverage report for src/mocks/msw.ts</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
    <div class='pad1'>
        <h1><a href="../../index.html">All files</a> / <a href="index.html">src/mocks</a> msw.ts</h1>
        <div class='clearfix'>
 ...
 */
&nbsp;
<span class="cstat-no" title="statement not covered" >import { setupServer } from 'msw/node';</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >export const server = setupServer();</span>
&nbsp;</pre></td></tr></table></pre>
