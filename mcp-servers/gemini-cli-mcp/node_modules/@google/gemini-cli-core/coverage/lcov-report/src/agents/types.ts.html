...
<head>
    <title>Code coverage report for src/agents/types.ts</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
    <div class='pad1'>
        <h1><a href="../../index.html">All files</a> / <a href="index.html">src/agents</a> types.ts</h1>
        <div class='clearfix'>
...
<a name='L184'></a><a href='#L184'>184</a></td><td class="line-coverage quiet"><span class="cline-any cline-no">&nbsp;</span>
 ...
 */
<span class="cstat-no" title="statement not covered" >export enum AgentTerminateMode {</span>
...
<span class="cstat-no" title="statement not covered" >  ABORTED = 'ABORTED',</span>
<span class="cstat-no" title="statement not covered" >  ERROR_NO_COMPLETE_TASK_CALL = 'ERROR_NO_COMPLETE_TASK_CALL',</span>
}
&nbsp;
/**
 ...
 */
<span class="cstat-no" title="statement not covered" >export const DEFAULT_QUERY_STRING = 'Get Started!';</span>
&nbsp;
/**
