...
<head>
    <title>Code coverage report for src/agents/codebase-investigator.ts</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
    <div class='pad1'>
        <h1><a href="../../index.html">All files</a> / <a href="index.html">src/agents</a> codebase-investigator.ts</h1>
        <div class='clearfix'>
...
<span class="cstat-no" title="statement not covered" >import { ThinkingLevel } from '@google/genai';</span>
&nbsp;
// Define a type that matches the outputConfig schema for type safety.
<span class="cstat-no" title="statement not covered" >const CodebaseInvestigationReportSchema = z.object({</span>
<span class="cstat-no" title="statement not covered" >  SummaryOfFindings: z</span>
<span class="cstat-no" title="statement not covered" >    .string()</span>
<span class="cstat-no" title="statement not covered" >    .describe(</span>
<span class="cstat-no" title="statement not covered" >      "A summary of the investigation's conclusions and insights for the main agent.",</span>
<span class="cstat-no" title="statement not covered" >    ),</span>
<span class="cstat-no" title="statement not covered" >  ExplorationTrace: z</span>
<span class="cstat-no" title="statement not covered" >    .array(z.string())</span>
<span class="cstat-no" title="statement not covered" >    .describe(</span>
<span class="cstat-no" title="statement not covered" >      'A step-by-step list of actions and tools used during the investigation.',</span>
<span class="cstat-no" title="statement not covered" >    ),</span>
<span class="cstat-no" title="statement not covered" >  RelevantLocations: z</span>
<span class="cstat-no" title="statement not covered" >    .array(</span>
<span class="cstat-no" title="statement not covered" >      z.object({</span>
<span class="cstat-no" title="statement not covered" >        FilePath: z.string(),</span>
<span class="cstat-no" title="statement not covered" >        Reasoning: z.string(),</span>
<span class="cstat-no" title="statement not covered" >        KeySymbols: z.array(z.string()),</span>
<span class="cstat-no" title="statement not covered" >      }),</span>
<span class="cstat-no" title="statement not covered" >    )</span>
<span class="cstat-no" title="statement not covered" >    .describe('A list of relevant files and the key symbols within them.'),</span>
<span class="cstat-no" title="statement not covered" >});</span>
&nbsp;
/**
 ...
 */
<span class="cstat-no" title="statement not covered" >export const CodebaseInvestigatorAgent = (</span>
<span class="cstat-no" title="statement not covered" >  config: Config,</span>
<span class="cstat-no" title="statement not covered" >): LocalAgentDefinition&lt;typeof CodebaseInvestigationReportSchema&gt; =&gt; {</span>
  // Use Preview Flash model if the main model is any of the preview models.
  // If the main model is not a preview model, use the default pro model.
<span class="cstat-no" title="statement not covered" >  const model = isPreviewModel(config.getModel())</span>
...
<span class="cstat-no" title="statement not covered" >    name: 'codebase_investigator',</span>
<span class="cstat-no" title="statement not covered" >    kind: 'local',</span>
<span class="cstat-no" title="statement not covered" >    displayName: 'Codebase Investigator Agent',</span>
<span class="cstat-no" title="statement not covered" >    description: `The specialized tool for codebase analysis, architectural mapping, and understanding system-wide dependencies.</span>
...
<span class="cstat-no" title="statement not covered" >          objective: {</span>
<span class="cstat-no" title="statement not covered" >            type: 'string',</span>
<span class="cstat-no" title="statement not covered" >            description: `A comprehensive and detailed description of the user's ultimate goal.</span>
          You must include original user's objective as well as questions and any extra context and questions you may have.`,
<span class="cstat-no" title="statement not covered" >          },</span>
<span class="cstat-no" title="statement not covered" >        },</span>
<span class="cstat-no" title="statement not covered" >        required: ['objective'],</span>
<span class="cstat-no" title="statement not covered" >      },</span>
<span class="cstat-no" title="statement not covered" >    },</span>
<span class="cstat-no" title="statement not covered" >    outputConfig: {</span>
<span class="cstat-no" title="statement not covered" >      outputName: 'report',</span>
<span class="cstat-no" title="statement not covered" >      description: 'The final investigation report as a JSON object.',</span>
<span class="cstat-no" title="statement not covered" >      schema: CodebaseInvestigationReportSchema,</span>
<span class="cstat-no" title="statement not covered" >    },</span>
&nbsp;
    // The 'output' parameter is now strongly typed as CodebaseInvestigationReportSchema
<span class="cstat-no" title="statement not covered" >    processOutput: (output) =&gt; JSON.stringify(output, null, 2),</span>
&nbsp;
...
<span class="cstat-no" title="statement not covered" >        thinkingConfig: isPreviewModel(model)</span>
<span class="cstat-no" title="statement not covered" >          ? {</span>
<span class="cstat-no" title="statement not covered" >              includeThoughts: true,</span>
<span class="cstat-no" title="statement not covered" >              thinkingLevel: ThinkingLevel.HIGH,</span>
<span class="cstat-no" title="statement not covered" >            }</span>
<span class="cstat-no" title="statement not covered" >          : {</span>
<span class="cstat-no" title="statement not covered" >              includeThoughts: true,</span>
<span class="cstat-no" title="statement not covered" >              thinkingBudget: DEFAULT_THINKING_MODE,</span>
<span class="cstat-no" title="statement not covered" >            },</span>
<span class="cstat-no" title="statement not covered" >      },</span>
<span class="cstat-no" title="statement not covered" >    },</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >    runConfig: {</span>
<span class="cstat-no" title="statement not covered" >      maxTimeMinutes: 3,</span>
<span class="cstat-no" title="statement not covered" >      maxTurns: 10,</span>
<span class="cstat-no" title="statement not covered" >    },</span>
&nbsp;
...
<span class="cstat-no" title="statement not covered" >        LS_TOOL_NAME,</span>
<span class="cstat-no" title="statement not covered" >        READ_FILE_TOOL_NAME,</span>
<span class="cstat-no" title="statement not covered" >        GLOB_TOOL_NAME,</span>
...
<span class="cstat-no" title="statement not covered" >      query: `Your task is to do a deep investigation of the codebase to find all relevant files, code locations, architectural mental map and insights to solve  for the following user objective:</span>
&lt;objective&gt;
\${objective}
&lt;/objective&gt;`,
<span class="cstat-no" title="statement not covered" >      systemPrompt: `You are **Codebase Investigator**, a hyper-specialized AI agent and an expert in reverse-engineering complex software projects. You are a sub-agent within a larger development system.</span>
