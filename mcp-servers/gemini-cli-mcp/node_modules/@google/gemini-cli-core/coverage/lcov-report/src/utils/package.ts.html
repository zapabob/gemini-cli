...
<head>
    <title>Code coverage report for src/utils/package.ts</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
    <div class='pad1'>
        <h1><a href="../../index.html">All files</a> / <a href="index.html">src/utils</a> package.ts</h1>
        <div class='clearfix'>
 ...
 * ```
 */
<span class="cstat-no" title="statement not covered" >export async function getPackageJson(</span>
<span class="cstat-no" title="statement not covered" >  cwd: string,</span>
<span class="cstat-no" title="statement not covered" >): Promise&lt;PackageJson | undefined&gt; {</span>
<span class="cstat-no" title="statement not covered" >  try {</span>
<span class="cstat-no" title="statement not covered" >    const result = await readPackageUp({ cwd, normalize: false });</span>
<span class="cstat-no" title="statement not covered" >    if (!result) {</span>
<span class="cstat-no" title="statement not covered" >      return undefined;</span>
<span class="cstat-no" title="statement not covered" >    }</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >    return result.packageJson;</span>
<span class="cstat-no" title="statement not covered" >  } catch (error) {</span>
<span class="cstat-no" title="statement not covered" >    debugLogger.error('Error occurred while reading package.json', error);</span>
<span class="cstat-no" title="statement not covered" >    return undefined;</span>
<span class="cstat-no" title="statement not covered" >  }</span>
<span class="cstat-no" title="statement not covered" >}</span>
&nbsp;</pre></td></tr></table></pre>
