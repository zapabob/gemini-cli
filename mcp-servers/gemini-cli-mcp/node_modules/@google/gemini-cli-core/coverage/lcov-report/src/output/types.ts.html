...
<head>
    <title>Code coverage report for src/output/types.ts</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
    <div class='pad1'>
        <h1><a href="../../index.html">All files</a> / <a href="index.html">src/output</a> types.ts</h1>
        <div class='clearfix'>
...
&nbsp;
<span class="cstat-no" title="statement not covered" >export enum OutputFormat {</span>
...
<span class="cstat-no" title="statement not covered" >  STREAM_JSON = 'stream-json',</span>
}
&nbsp;
...
<span class="cstat-no" title="statement not covered" >export enum JsonStreamEventType {</span>
...
<span class="cstat-no" title="statement not covered" >  TOOL_USE = 'tool_use',</span>
<span class="cstat-no" title="statement not covered" >  TOOL_RESULT = 'tool_result',</span>
