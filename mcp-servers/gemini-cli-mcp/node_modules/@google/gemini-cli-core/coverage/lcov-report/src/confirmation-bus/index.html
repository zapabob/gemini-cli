...
<head>
    <title>Code coverage report for src/confirmation-bus</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
    <div class='pad1'>
        <h1><a href="../../index.html">All files</a> src/confirmation-bus</h1>
        <div class='clearfix'>
...
<tr>
	<td class="file low" data-value="message-bus.ts"><a href="message-bus.ts.html">message-bus.ts</a></td>
	<td data-value="0" class="pic low">
	<div class="chart"><div class="cover-fill" style="width: 0%"></div><div class="cover-empty" style="width: 100%"></div></div>
	</td>
	<td data-value="0" class="pct low">0%</td>
