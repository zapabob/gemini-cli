...
<head>
    <title>Code coverage report for src/confirmation-bus/types.ts</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
    <div class='pad1'>
        <h1><a href="../../index.html">All files</a> / <a href="index.html">src/confirmation-bus</a> types.ts</h1>
        <div class='clearfix'>
...
<a name='L179'></a><a href='#L179'>179</a></td><td class="line-coverage quiet"><span class="cline-any cline-no">&nbsp;</span>
...
&nbsp;
<span class="cstat-no" title="statement not covered" >export enum MessageBusType {</span>
<span class="cstat-no" title="statement not covered" >  TOOL_CONFIRMATION_REQUEST = 'tool-confirmation-request',</span>
<span class="cstat-no" title="statement not covered" >  TOOL_CONFIRMATION_RESPONSE = 'tool-confirmation-response',</span>
<span class="cstat-no" title="statement not covered" >  TOOL_POLICY_REJECTION = 'tool-policy-rejection',</span>
<span class="cstat-no" title="statement not covered" >  TOOL_EXECUTION_SUCCESS = 'tool-execution-success',</span>
<span class="cstat-no" title="statement not covered" >  TOOL_EXECUTION_FAILURE = 'tool-execution-failure',</span>
<span class="cstat-no" title="statement not covered" >  UPDATE_POLICY = 'update-policy',</span>
<span class="cstat-no" title="statement not covered" >  TOOL_CALLS_UPDATE = 'tool-calls-update',</span>
<span class="cstat-no" title="statement not covered" >  ASK_USER_REQUEST = 'ask-user-request',</span>
<span class="cstat-no" title="statement not covered" >  ASK_USER_RESPONSE = 'ask-user-response',</span>
}
&nbsp;
...
&nbsp;
<span class="cstat-no" title="statement not covered" >export enum QuestionType {</span>
<span class="cstat-no" title="statement not covered" >  CHOICE = 'choice',</span>
<span class="cstat-no" title="statement not covered" >  TEXT = 'text',</span>
<span class="cstat-no" title="statement not covered" >  YESNO = 'yesno',</span>
}
&nbsp;
