...
<head>
    <title>Code coverage report for src/telemetry/constants.ts</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
    <div class='pad1'>
        <h1><a href="../../index.html">All files</a> / <a href="index.html">src/telemetry</a> constants.ts</h1>
        <div class='clearfix'>
 ...
 */
&nbsp;
<span class="cstat-no" title="statement not covered" >export const SERVICE_NAME = 'gemini-cli';</span>
&nbsp;</pre></td></tr></table></pre>
